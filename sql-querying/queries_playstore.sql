...
SELECT * FROM analytics WHERE min_installs < 50 AND rating != 0;
...
SELECT app_name, reviews, min_installs, min_installs/reviews AS proportion FROM analytics WHERE min_installs >= 100000 LIMIT 1;
